...
/*Data Variables*/
extern const unsigned char background_wav[];
extern const unsigned int background_wav_len;
extern const unsigned char coin_wav[];
extern const unsigned int coin_wav_len;
extern const unsigned char dyingsfx_wav[];
extern const unsigned int dyingsfx_wav_len;
extern const unsigned char GetLucky_wav[];
extern const unsigned int GetLucky_wav_len;
extern const unsigned char hit_wav[];
extern const unsigned int hit_wav_len;
extern const unsigned char SeeYouAgain_wav[];
extern const unsigned int SeeYouAgain_wav_len;
